        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Capitals_Users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NetProfitOrLoss = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    ProfitLossPercentage = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MonthlyReports_Users_GeneratedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Capitals_CreatedByUserId",
                table: "Capitals",
                column: "CreatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonthlyReports_GeneratedByUserId",
                table: "MonthlyReports",
                column: "GeneratedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MonthlyReports_Month_Year",
                table: "MonthlyReports",
